...
public interface RestSpreadsheets {
	...
	static final String HEADER_VERSION = "Sheetsserver-version";
	...
	@Path("/{sheetId}")
	@Produces(MediaType.APPLICATION_JSON)
	Spreadsheet getSpreadsheet(@HeaderParam(RestSpreadsheets.HEADER_VERSION) int version, @PathParam("sheetId") String sheetId , @QueryParam("userId") String userId, 
	...
	@Path("/{sheetId}/values")
	@Produces(MediaType.APPLICATION_JSON)
	String[][] getSpreadsheetValues(@HeaderParam(RestSpreadsheets.HEADER_VERSION) int version, @PathParam("sheetId") String sheetId, 
	...
	@Path("/{sheetId}/range")
	@Produces(MediaType.APPLICATION_JSON)
	ValuesResult getRange(@HeaderParam(RestSpreadsheets.HEADER_VERSION) int version, @PathParam("sheetId") String sheetId, 
	...
	@DELETE
	@Path("/delete/{userId}")
	void deleteUserSpreadsheets( @PathParam("userId") String userId, @QueryParam("serverSecret") String serverSecret);
}